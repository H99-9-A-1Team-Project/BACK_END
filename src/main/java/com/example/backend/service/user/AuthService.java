...
import com.example.backend.exception.LoginFailureException;
import com.example.backend.exception.MemberEmailAlreadyExistsException;
...
public class AuthService {
    ...
    @Transactional
    public TokenResponseDto login2(LoginRequestDto loginRequestDto) {
        User user = userRepository.findByEmail(loginRequestDto.getEmail()).orElseThrow(LoginFailureException::new);

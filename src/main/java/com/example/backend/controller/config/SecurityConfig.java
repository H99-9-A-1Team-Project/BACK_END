...
import com.example.backend.controller.config.jwt.JwtAccessDeniedHandler;
import com.example.backend.controller.config.jwt.JwtAuthenticationEntryPoint;
import com.example.backend.controller.config.jwt.JwtSecurityConfig;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/api/signup","/api/realtor/signup", "/api/login", "/api/realtor/login", "/api/reissue").permitAll()
